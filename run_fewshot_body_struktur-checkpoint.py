...
# cuda = '0'
# output_file = 'fewshot_body_llama'
# -
...
file_path_1shot = './prompts/new_body_struktur_1shot.txt'
with open(file_path_1shot, 'r') as file:
    prompt_1shot = file.read()

file_path_2shot = './prompts/new_body_struktur_2shot.txt'
...
test_dataset_name = "dataset-surface-info/body-struktur-fin/body-struktur-fin-1"
