...
def extract_turtle_opening(regulatory_id, turtle_file_path, text_file_path):
    target_file = text_file_path.replace('new_1_text_files', 'new_3_turtle_files')
    target_file = target_file.replace('txt', 'ttl')
    
    print(f'OPENING {regulatory_id} {target_file}')
...
def extract_turtle_closing(regulatory_id, turtle_file_path, text_file_path):
    target_file = text_file_path.replace('new_1_text_files', 'new_4_turtle_files')
    target_file = target_file.replace('txt', 'ttl')
    
    print(f'CLOSING {regulatory_id} {target_file}')
    ...
    try:
        ...
        print(e)
        with open('error4.txt', 'a') as f: 
            f.write(f'{regulatory_id} {turtle_file_path}\n')

    end = time.time()
    print(f'{regulatory_id} from {turtle_file_path} to {target_file} execution time {end - start} seconds')

def extract_turtle_body(regulatory_id, turtle_file_path, text_file_path):
    target_file = text_file_path.replace('new_1_text_files', 'new_5_turtle_files')
    target_file = target_file.replace('txt', 'ttl')
    
    print(f'BODY {regulatory_id} {target_file}')
...
#     extract_turtle_opening(regulatory_id, turtle_file_path, text_file_path)
    extract_turtle_closing(regulatory_id, turtle_file_path, text_file_path)
#     extract_turtle_body(regulatory_id, turtle_file_path, text_file_path)
