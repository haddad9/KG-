...
# model_name = 'codellama/CodeLlama-7b-Instruct-hf'
cuda = '0'
output_file = 'fewshot_opening_code_phi_test.csv'
...
# +
file_path_opening_1shot_1 = './prompts/opening_code_1shot_1.txt'
...
# +
file_path_opening_2shot_1 = './prompts/opening_code_2shot_1.txt'
...
test_dataset_name = "dataset-surface-info/new-dataset/new-opening/new-opening-1"
...
cnt = 0
for i in tqdm(range(len(test_dataset))[0:1]):
